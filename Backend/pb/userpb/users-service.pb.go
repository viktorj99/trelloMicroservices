...
// Request and response for GetAllUsers
...
// Request and response for CheckUserExistsByID
type CheckUserExistsByIDRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UserId string `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // User ID to check
}
...
func (x *CheckUserExistsByIDRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
type CheckUserExistsByIDResponse struct {
	...
	Exists bool `protobuf:"varint,1,opt,name=exists,proto3" json:"exists,omitempty"` // Whether the user exists or not
}

func (x *CheckUserExistsByIDResponse) Reset() {
	*x = CheckUserExistsByIDResponse{}
	mi := &file_users_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CheckUserExistsByIDResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckUserExistsByIDResponse) ProtoMessage() {}

func (x *CheckUserExistsByIDResponse) ProtoReflect() protoreflect.Message {
	mi := &file_users_service_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckUserExistsByIDResponse.ProtoReflect.Descriptor instead.
func (*CheckUserExistsByIDResponse) Descriptor() ([]byte, []int) {
	return file_users_service_proto_rawDescGZIP(), []int{3}
}

func (x *CheckUserExistsByIDResponse) GetExists() bool {
	if x != nil {
		return x.Exists
	}
	return false
...
var file_users_service_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_users_service_proto_goTypes = []any{
	...
	(*CheckUserExistsByIDRequest)(nil),  // 2: userservice.CheckUserExistsByIDRequest
	(*CheckUserExistsByIDResponse)(nil), // 3: userservice.CheckUserExistsByIDResponse
	(*User)(nil),                        // 4: userservice.User
}
var file_users_service_proto_depIdxs = []int32{
	4, // 0: userservice.GetAllUsersResponse.users:type_name -> userservice.User
	0, // 1: userservice.UserService.GetAllUsers:input_type -> userservice.GetAllUsersRequest
	2, // 2: userservice.UserService.CheckUserExistsByID:input_type -> userservice.CheckUserExistsByIDRequest
	1, // 3: userservice.UserService.GetAllUsers:output_type -> userservice.GetAllUsersResponse
	3, // 4: userservice.UserService.CheckUserExistsByID:output_type -> userservice.CheckUserExistsByIDResponse
